<script type="text/javascript">
    $(function() {
        ...
        $( "#to_wl" ).click(function(){
            var id = $( "#id_rekanan" ).val();
            if (!$('.form_perpanjangan input[type="checkbox"]').is(':checked'))
                alert('Silahkan pilih rekanan!');
            else
                $( "form.form_perpanjangan" ).submit();
        });
        
        $( "button#letters" ).click(function(){
            var letter = $(this).val();
            var link = base+"search/get_perpanjangan/"+letter;
            $.ajax({
                url: link,
...
<ul class="breadcrumb">
    ...
    <li class="active">Perpanjang Rekanan</li>
</ul>
...
<div class="container-fluid">
    <div class="row-fluid">
        ...
        <div class="btn-toolbar" >
            <a id="to_wl" href="#" class="btn btn-primary">Masukkan ke Waiting List</a>
            <?php
        ...
        <div id="show">
            <?php $this->load->view('perpanjangan/show_perpanjangan'); ?>
        </div>
